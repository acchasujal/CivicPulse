...
5 agents, in sequence: Issue Understanding → Issue Verification → Impact Intelligence → Action Generator → Escalation Agent. FastAPI backend, SQLite, React/Vite frontend, Gemini 2.0 Flash for Agents 1–4, real SMTP/PDF for Agent 5. Full detail: `ARCHITECTURE.md`.
...
3. RTI/complaint drafts must always include the disclaimer: "AI-generated draft. Review before submission." (Truth 4).
